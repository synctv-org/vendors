...
require (
	github.com/go-kratos/kratos/contrib/registry/consul/v2 v2.0.0-20231209151259-7e2edecabf32
	github.com/go-kratos/kratos/contrib/registry/etcd/v2 v2.0.0-20231209151259-7e2edecabf32
