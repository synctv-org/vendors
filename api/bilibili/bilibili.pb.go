...
type GetSubtitlesResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Subtitles     map[string]string      `protobuf:"bytes,1,rep,name=subtitles,proto3" json:"subtitles,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetLiveDanmuInfoReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Cookies       map[string]string      `protobuf:"bytes,1,rep,name=cookies,proto3" json:"cookies,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	RoomID        uint64                 `protobuf:"varint,2,opt,name=roomID,proto3" json:"roomID,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *GetLiveDanmuInfoReq) Reset() {
	*x = GetLiveDanmuInfoReq{}
	mi := &file_bilibili_bilibili_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetLiveDanmuInfoReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLiveDanmuInfoReq) ProtoMessage() {}

func (x *GetLiveDanmuInfoReq) ProtoReflect() protoreflect.Message {
	mi := &file_bilibili_bilibili_proto_msgTypes[30]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLiveDanmuInfoReq.ProtoReflect.Descriptor instead.
func (*GetLiveDanmuInfoReq) Descriptor() ([]byte, []int) {
	return file_bilibili_bilibili_proto_rawDescGZIP(), []int{30}
}

func (x *GetLiveDanmuInfoReq) GetCookies() map[string]string {
	if x != nil {
		return x.Cookies
	}
	return nil
...
func (x *GetLiveDanmuInfoReq) GetRoomID() uint64 {
	if x != nil {
		return x.RoomID
	}
	return 0
...
type GetLiveDanmuInfoResp struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Token         string                       `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	HostList      []*GetLiveDanmuInfoResp_Host `protobuf:"bytes,2,rep,name=hostList,proto3" json:"hostList,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetLiveDanmuInfoResp) Reset() {
	*x = GetLiveDanmuInfoResp{}
	mi := &file_bilibili_bilibili_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetLiveDanmuInfoResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLiveDanmuInfoResp) ProtoMessage() {}

func (x *GetLiveDanmuInfoResp) ProtoReflect() protoreflect.Message {
	mi := &file_bilibili_bilibili_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLiveDanmuInfoResp.ProtoReflect.Descriptor instead.
func (*GetLiveDanmuInfoResp) Descriptor() ([]byte, []int) {
	return file_bilibili_bilibili_proto_rawDescGZIP(), []int{31}
}

func (x *GetLiveDanmuInfoResp) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *GetLiveDanmuInfoResp) GetHostList() []*GetLiveDanmuInfoResp_Host {
	if x != nil {
		return x.HostList
	}
	return nil
...
type GetLiveDanmuInfoResp_Host struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Host          string                 `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
	Port          uint32                 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"`
	WssPort       uint32                 `protobuf:"varint,3,opt,name=wss_port,json=wssPort,proto3" json:"wss_port,omitempty"`
	WsPort        uint32                 `protobuf:"varint,4,opt,name=ws_port,json=wsPort,proto3" json:"ws_port,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetLiveDanmuInfoResp_Host) Reset() {
	*x = GetLiveDanmuInfoResp_Host{}
	mi := &file_bilibili_bilibili_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetLiveDanmuInfoResp_Host) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLiveDanmuInfoResp_Host) ProtoMessage() {}

func (x *GetLiveDanmuInfoResp_Host) ProtoReflect() protoreflect.Message {
	mi := &file_bilibili_bilibili_proto_msgTypes[46]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLiveDanmuInfoResp_Host.ProtoReflect.Descriptor instead.
func (*GetLiveDanmuInfoResp_Host) Descriptor() ([]byte, []int) {
	return file_bilibili_bilibili_proto_rawDescGZIP(), []int{31, 0}
}

func (x *GetLiveDanmuInfoResp_Host) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *GetLiveDanmuInfoResp_Host) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *GetLiveDanmuInfoResp_Host) GetWssPort() uint32 {
	if x != nil {
		return x.WssPort
	}
	return 0
...
func (x *GetLiveDanmuInfoResp_Host) GetWsPort() uint32 {
	if x != nil {
		return x.WsPort
	}
	return 0
...
var file_bilibili_bilibili_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_bilibili_bilibili_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_bilibili_bilibili_proto_goTypes = []any{
	...
	(*GetLiveDanmuInfoReq)(nil),       // 31: api.bilibili.GetLiveDanmuInfoReq
	(*GetLiveDanmuInfoResp)(nil),      // 32: api.bilibili.GetLiveDanmuInfoResp
	nil,                               // 33: api.bilibili.LoginWithQRCodeResp.CookiesEntry
	nil,                               // 34: api.bilibili.LoginWithSMSResp.CookiesEntry
	nil,                               // 35: api.bilibili.ParseVideoPageReq.CookiesEntry
	nil,                               // 36: api.bilibili.GetVideoURLReq.CookiesEntry
	nil,                               // 37: api.bilibili.GetDashVideoURLReq.CookiesEntry
	nil,                               // 38: api.bilibili.GetSubtitlesReq.CookiesEntry
	nil,                               // 39: api.bilibili.GetSubtitlesResp.SubtitlesEntry
	nil,                               // 40: api.bilibili.ParsePGCPageReq.CookiesEntry
	nil,                               // 41: api.bilibili.GetPGCURLReq.CookiesEntry
	nil,                               // 42: api.bilibili.GetDashPGCURLReq.CookiesEntry
	nil,                               // 43: api.bilibili.UserInfoReq.CookiesEntry
	nil,                               // 44: api.bilibili.GetLiveStreamsReq.CookiesEntry
	nil,                               // 45: api.bilibili.ParseLivePageReq.CookiesEntry
	nil,                               // 46: api.bilibili.GetLiveDanmuInfoReq.CookiesEntry
	(*GetLiveDanmuInfoResp_Host)(nil), // 47: api.bilibili.GetLiveDanmuInfoResp.Host
}
var file_bilibili_bilibili_proto_depIdxs = []int32{
	...
	33, // 1: api.bilibili.LoginWithQRCodeResp.cookies:type_name -> api.bilibili.LoginWithQRCodeResp.CookiesEntry
	34, // 2: api.bilibili.LoginWithSMSResp.cookies:type_name -> api.bilibili.LoginWithSMSResp.CookiesEntry
	11, // 3: api.bilibili.VideoPageInfo.videoInfos:type_name -> api.bilibili.VideoInfo
	35, // 4: api.bilibili.ParseVideoPageReq.cookies:type_name -> api.bilibili.ParseVideoPageReq.CookiesEntry
	36, // 5: api.bilibili.GetVideoURLReq.cookies:type_name -> api.bilibili.GetVideoURLReq.CookiesEntry
	37, // 6: api.bilibili.GetDashVideoURLReq.cookies:type_name -> api.bilibili.GetDashVideoURLReq.CookiesEntry
	38, // 7: api.bilibili.GetSubtitlesReq.cookies:type_name -> api.bilibili.GetSubtitlesReq.CookiesEntry
	39, // 8: api.bilibili.GetSubtitlesResp.subtitles:type_name -> api.bilibili.GetSubtitlesResp.SubtitlesEntry
	40, // 9: api.bilibili.ParsePGCPageReq.cookies:type_name -> api.bilibili.ParsePGCPageReq.CookiesEntry
	41, // 10: api.bilibili.GetPGCURLReq.cookies:type_name -> api.bilibili.GetPGCURLReq.CookiesEntry
	42, // 11: api.bilibili.GetDashPGCURLReq.cookies:type_name -> api.bilibili.GetDashPGCURLReq.CookiesEntry
	43, // 12: api.bilibili.UserInfoReq.cookies:type_name -> api.bilibili.UserInfoReq.CookiesEntry
	44, // 13: api.bilibili.GetLiveStreamsReq.cookies:type_name -> api.bilibili.GetLiveStreamsReq.CookiesEntry
	28, // 14: api.bilibili.GetLiveStreamsResp.liveStreams:type_name -> api.bilibili.LiveStream
	45, // 15: api.bilibili.ParseLivePageReq.cookies:type_name -> api.bilibili.ParseLivePageReq.CookiesEntry
	46, // 16: api.bilibili.GetLiveDanmuInfoReq.cookies:type_name -> api.bilibili.GetLiveDanmuInfoReq.CookiesEntry
	47, // 17: api.bilibili.GetLiveDanmuInfoResp.hostList:type_name -> api.bilibili.GetLiveDanmuInfoResp.Host
	1,  // 18: api.bilibili.Bilibili.NewQRCode:input_type -> api.bilibili.Empty
	3,  // 19: api.bilibili.Bilibili.LoginWithQRCode:input_type -> api.bilibili.LoginWithQRCodeReq
	1,  // 20: api.bilibili.Bilibili.NewCaptcha:input_type -> api.bilibili.Empty
	6,  // 21: api.bilibili.Bilibili.NewSMS:input_type -> api.bilibili.NewSMSReq
	8,  // 22: api.bilibili.Bilibili.LoginWithSMS:input_type -> api.bilibili.LoginWithSMSReq
	12, // 23: api.bilibili.Bilibili.ParseVideoPage:input_type -> api.bilibili.ParseVideoPageReq
	14, // 24: api.bilibili.Bilibili.GetVideoURL:input_type -> api.bilibili.GetVideoURLReq
	15, // 25: api.bilibili.Bilibili.GetDashVideoURL:input_type -> api.bilibili.GetDashVideoURLReq
	17, // 26: api.bilibili.Bilibili.GetSubtitles:input_type -> api.bilibili.GetSubtitlesReq
	19, // 27: api.bilibili.Bilibili.ParsePGCPage:input_type -> api.bilibili.ParsePGCPageReq
	20, // 28: api.bilibili.Bilibili.GetPGCURL:input_type -> api.bilibili.GetPGCURLReq
	21, // 29: api.bilibili.Bilibili.GetDashPGCURL:input_type -> api.bilibili.GetDashPGCURLReq
	23, // 30: api.bilibili.Bilibili.UserInfo:input_type -> api.bilibili.UserInfoReq
	25, // 31: api.bilibili.Bilibili.Match:input_type -> api.bilibili.MatchReq
	27, // 32: api.bilibili.Bilibili.GetLiveStreams:input_type -> api.bilibili.GetLiveStreamsReq
	30, // 33: api.bilibili.Bilibili.ParseLivePage:input_type -> api.bilibili.ParseLivePageReq
	31, // 34: api.bilibili.Bilibili.GetLiveDanmuInfo:input_type -> api.bilibili.GetLiveDanmuInfoReq
	2,  // 35: api.bilibili.Bilibili.NewQRCode:output_type -> api.bilibili.NewQRCodeResp
	4,  // 36: api.bilibili.Bilibili.LoginWithQRCode:output_type -> api.bilibili.LoginWithQRCodeResp
	5,  // 37: api.bilibili.Bilibili.NewCaptcha:output_type -> api.bilibili.NewCaptchaResp
	7,  // 38: api.bilibili.Bilibili.NewSMS:output_type -> api.bilibili.NewSMSResp
	9,  // 39: api.bilibili.Bilibili.LoginWithSMS:output_type -> api.bilibili.LoginWithSMSResp
	10, // 40: api.bilibili.Bilibili.ParseVideoPage:output_type -> api.bilibili.VideoPageInfo
	13, // 41: api.bilibili.Bilibili.GetVideoURL:output_type -> api.bilibili.VideoURL
	16, // 42: api.bilibili.Bilibili.GetDashVideoURL:output_type -> api.bilibili.GetDashVideoURLResp
	18, // 43: api.bilibili.Bilibili.GetSubtitles:output_type -> api.bilibili.GetSubtitlesResp
	10, // 44: api.bilibili.Bilibili.ParsePGCPage:output_type -> api.bilibili.VideoPageInfo
	13, // 45: api.bilibili.Bilibili.GetPGCURL:output_type -> api.bilibili.VideoURL
	22, // 46: api.bilibili.Bilibili.GetDashPGCURL:output_type -> api.bilibili.GetDashPGCURLResp
	24, // 47: api.bilibili.Bilibili.UserInfo:output_type -> api.bilibili.UserInfoResp
	26, // 48: api.bilibili.Bilibili.Match:output_type -> api.bilibili.MatchResp
	29, // 49: api.bilibili.Bilibili.GetLiveStreams:output_type -> api.bilibili.GetLiveStreamsResp
	10, // 50: api.bilibili.Bilibili.ParseLivePage:output_type -> api.bilibili.VideoPageInfo
	32, // 51: api.bilibili.Bilibili.GetLiveDanmuInfo:output_type -> api.bilibili.GetLiveDanmuInfoResp
