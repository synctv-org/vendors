...
func (c *alistClient) Login(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*LoginResp, error) {
	...
	out := new(LoginResp)
	err := c.cc.Invoke(ctx, Alist_Login_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alistClient) Me(ctx context.Context, in *MeReq, opts ...grpc.CallOption) (*MeResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MeResp)
	err := c.cc.Invoke(ctx, Alist_Me_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alistClient) FsGet(ctx context.Context, in *FsGetReq, opts ...grpc.CallOption) (*FsGetResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FsGetResp)
	err := c.cc.Invoke(ctx, Alist_FsGet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alistClient) FsList(ctx context.Context, in *FsListReq, opts ...grpc.CallOption) (*FsListResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FsListResp)
	err := c.cc.Invoke(ctx, Alist_FsList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alistClient) FsOther(ctx context.Context, in *FsOtherReq, opts ...grpc.CallOption) (*FsOtherResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FsOtherResp)
	err := c.cc.Invoke(ctx, Alist_FsOther_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alistClient) FsSearch(ctx context.Context, in *FsSearchReq, opts ...grpc.CallOption) (*FsSearchResp, error) {
	...
	err := c.cc.Invoke(ctx, Alist_FsSearch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAlistServer must be embedded to have
...
func (UnimplementedAlistServer) testEmbeddedByValue()               {}
...
func RegisterAlistServer(s grpc.ServiceRegistrar, srv AlistServer) {
	// If the following call pancis, it indicates UnimplementedAlistServer was
