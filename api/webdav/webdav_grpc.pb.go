...
func (c *webdavClient) FsGet(ctx context.Context, in *FsGetReq, opts ...grpc.CallOption) (*FsGetResp, error) {
	out := new(FsGetResp)
	err := c.cc.Invoke(ctx, Webdav_FsGet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webdavClient) FsList(ctx context.Context, in *FsListReq, opts ...grpc.CallOption) (*FsListResp, error) {
	out := new(FsListResp)
	err := c.cc.Invoke(ctx, Webdav_FsList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webdavClient) FsSearch(ctx context.Context, in *FsSearchReq, opts ...grpc.CallOption) (*FsSearchResp, error) {
	...
	err := c.cc.Invoke(ctx, Webdav_FsSearch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *webdavClient) FsTest(ctx context.Context, in *FsTestReq, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Webdav_FsTest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
